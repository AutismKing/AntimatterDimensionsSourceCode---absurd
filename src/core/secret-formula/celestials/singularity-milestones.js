...
export const singularityMilestones = {
  ...
  darkDimensionCostReduction: {
    ...
    effectFormat: x => `/ ${format(x.recip(), 2, 2)}`, //pre-copying from endgame this was: effectFormat: x => `/ ${format(1 / x, 2, 2)}`,
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  singularityMult: {
    id: 5,
  ...
  multFromInfinitied: {
    ...
    effect: () => Decimal.clampMin(new Decimal(Currency.infinitiesTotal.value.log10()).div(1000), 1), //max 1 was here
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
