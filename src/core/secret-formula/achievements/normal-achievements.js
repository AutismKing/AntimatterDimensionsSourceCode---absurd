export const normalAchievements = [
  ...
  },
  {
    ...
    checkRequirement: () => Currency.antimatter.value.max(1).log10().gte(80),
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimension(1).amount.max(1).log10().gte(150),
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimensions.all.some(x => x.multiplier.max(1).log10().gte(31)),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.value.max(1).log10().gte(63) &&
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimension(7).amount.max(1).log10().gte(12),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 47,
  ...
  },
  {
    ...
    checkRequirement: () => Player.bestRunIPPM.max(1).log10().gte(8),
    checkEvent: GAME_EVENT.BIG_CRUNCH_AFTER
  },
  {
    id: 63,
  ...
  },
  {
    ...
    effect: () => Decimal.max(Decimal.pow(Time.totalTimePlayed.totalDays.div(2), 0.05), 1).toNumber(),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 77,
    ...
    checkRequirement: () => Currency.infinityPower.value.max(1).log10().gte(6),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 78,
  ...
  },
  {
    ...
    checkRequirement: () => Currency.antimatter.value.max(1).log10().gte(35000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().max(1).log10().gte(150),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().max(1).log10().gte(200) && Time.thisInfinityRealTime.totalSeconds.lte(2),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `All Antimatter Dimensions are significantly stronger in the
      first ${formatInt(5)} seconds of Infinities.`;
    },
    effect: () => Decimal.max((new Decimal(5).sub(Time.thisInfinity.totalSeconds)).times(60), 1).toNumber(),
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().max(1).log10().gte(250) && Time.thisInfinityRealTime.totalSeconds.lte(20),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `All Antimatter Dimensions are significantly stronger in the
      first ${formatInt(60)} seconds of Infinities.`;
    },
    effect: () => Decimal.max((new Decimal(1).sub(Time.thisInfinity.totalMinutes)).times(100), 1).toNumber(),
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().max(1).log10().gte(300),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Additional ${formatX(4)} multiplier to Infinity Points.`; },
    effect: 4
  },
  {
    ...
    checkRequirement: () => Currency.infinityPower.value.max(1).log10().gte(260),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => Currency.infinityPoints.value.max(1).log10().gte(1000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () => Sacrifice.totalBoost.max(1).log10().gte(9000),
    checkEvent: GAME_EVENT.SACRIFICE_RESET_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => Currency.infinityPoints.value.max(1).log10().gte(30008),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 122,
  ...
  },
  {
    ...
    effect() {
      ...
      return DC.D2.pow(Decimal.log(thisInfinity).times(Decimal.min(Decimap.pow(thisInfinity, 0.11)), 500));
    },
    cap: () => Effarig.eternityCap,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  ...
  },
  {
    ...
    checkRequirement: () => Currency.infinityPoints.value.max(1).log10().gte(22000) && player.timestudy.studies.length === 0,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () =>
      ...
      Currency.infinityPoints.value.max(1).log10().gte(200000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => Replicanti.amount.max(1).log10().gte(18000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.value.max(1).log10().gte(260000) &&
  ...
  },
  {
    ...
    checkRequirement: () =>
      ...
      player.dilation.active &&
      Currency.infinityPoints.value.max(1).log10().gte(26000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => Currency.antimatter.value.max(1).log10().gte(100000000) && player.dilation.active,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 162,
